...
<body>
    ...
    <section id="siswa">
        <div class="container mt-5">
            ...
            <div class="row justify-content-evenly fs-5 text-center align-items-center table-responsive">
                <div class="table-responsive">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>2</td>
                                <td>210098</td>
                                <td>Livendi Hermawan Pradana, S.Sn.</td>
                                <td>Guru Agama</td>
                                <td>Laki-laki</td>
                                <td>Medan Sunggal</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>210964</td>
                                <td>Katherine Her Pratiwi, S.Si., M.Pd.</td>
                            ...
                            <tr>
                                <td>6</td>
                                <td>210934</td>
                                <td>Johan Pamungkas, S.Pd., M.Pd.</td>
                                <td>Guru Fisika</td>
                                <td>Laki-laki</td>
                                <td>Medan Polonia</td>
                            </tr>
                            <tr>
                                <td>7</td>
                                <td>210013</td>
                                <td>Oktian Primanda Wibowo, S.Pd.</td>
                                <td>Guru Penjaskes</td>
                                <td>Laki-laki</td>
                                <td>Babura Sunggal</td>
                            </tr>
                            <tr>
                                <td>8</td>
                                <td>210017</td>
                                <td>Hana Sih Setya Gumelar, S.Pd.</td>
                                <td>Guru BP/BK</td>
                                <td>Perempuan</td>
                                <td>Gaperta</td>
                            </tr>
                            ...
                            <tr>
                                <td>10</td>
                                <td>210017</td>
                                <td>Cynthia Meylawati, S.Pd., M.Pd.</td>
                                <td>Guru TIK</td>
                                <td>Perempuan</td>
                                <td>Medan Area</td>
